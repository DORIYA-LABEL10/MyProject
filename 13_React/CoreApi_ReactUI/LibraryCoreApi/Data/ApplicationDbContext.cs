    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Author>().HasData(
                new Author { AuthorId = 1, AuthorName = "Foysal", DoB = DateTime.Parse("01/01/1980"), Phone = "01947193694", Email = "foysal@mail.com", IsActive = true },
                new Author { AuthorId = 2, AuthorName = "Wahid", DoB = DateTime.Parse("01/01/1987"), Phone = "01747193694", Email = "wahid@mail.com", IsActive = true },
                new Author { AuthorId = 3, AuthorName = "Rasel", DoB = DateTime.Parse("01/01/1995"), Phone = "01547193694", Email = "rasel@mail.com", IsActive = true }
            );
